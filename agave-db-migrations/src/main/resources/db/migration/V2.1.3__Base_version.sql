...
CREATE TABLE `authconfigs` (
  ...
  `private_key` varchar(4098) DEFAULT NULL,
  `public_key` varchar(4098) DEFAULT NULL,
...
CREATE TABLE `monitors` (
  ...
  `owner` varchar(32) NOT NULL,
  `tenant_id` varchar(128) NOT NULL,
  `update_system_status` bit(1) DEFAULT NULL,
  `uuid` varchar(64) NOT NULL,
...
CREATE TABLE `notifications` (
  ...
  `tenant_id` varchar(128) NOT NULL,
  `uuid` varchar(64) NOT NULL,
  `is_terminated` bit(1) DEFAULT b'0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `uuid` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `software_inputs` (
  ...
  `enquote` bit(1) NOT NULL,
  `max_cardinality` int(11) NOT NULL DEFAULT '-1',
  `repeat_cli_argument` bit(1) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
...
VALUES
	(1,'XSEDE','https://api.xsede.org/','help@xsede.org','XSEDE Help Staff','2014-01-22 00:48:10','2014-01-22 00:48:10','LIVE','xsede.org','0001411570898766-b0b0b0bb0b-0001-016'),
	(2,'iPlant Collaborative Science APIs','https://agave.iplantc.org/','dooley@tacc.utexas.edu','Rion Dooley','2014-01-22 01:18:56','2014-01-22 01:18:56','LIVE','iplantc.org','0001411570898781-b0b0b0bb0b-0001-016'),
	(3,'VDJ Server','https://wso2-elb.tacc.utexas.edu/','mock@tacc.utexas.edu','Steve Mock','2014-01-22 10:52:52','2014-01-22 10:52:52','LIVE','vdjserver.org','0001411570898793-b0b0b0bb0b-0001-016'),
	(4,'XSEDE Staging','https://wso2-gateway.tacc.utexas.edu','jstubbs@tacc.utexas.edu','Joe Stubbs','2014-01-22 10:53:51','2014-01-22 10:53:51','LIVE','xsede.org.staging','0001411570898803-b0b0b0bb0b-0001-016'),
	(5,'Agave Development Tenant','https://wso2-auth.tacc.utexas.edu/','jstubbs@tacc.utexas.edu','Joe Stubbs','2014-01-22 10:53:51','2014-01-22 10:53:51','LIVE','wso2.agave.staging','0001411570898814-b0b0b0bb0b-0001-016'),
	(6,'Araport','https://api.araport.org/','vaughn@tacc.utexas.edu','Matt Vaughn','2014-01-22 10:54:58','2014-01-22 10:54:58','LIVE','araport.org','0001411570898826-b0b0b0bb0b-0001-016'),
	(7,'iReceptor','https://irec.agave.tacc.utexas.edu/','bcorrie@sfu.ca','Brian Corrie','2014-08-11 01:52:36','2014-08-11 01:52:36','LIVE','irec','0001411570898837-b0b0b0bb0b-0001-016'),
	(8,'TACC','https://api.tacc.utexas.edu/','mock@tacc.utexas.edu','Steve Mock','2015-02-03 09:54:37','2015-02-03 11:31:38','LIVE','tacc.prod','0001423978050162-b0b0b0bb0b-0001-016');
